...
from finlib.simulation.simulation_interface import ISimulation


class GeometricBrownianMotion(ISimulation):
...
class JumpDiffusion(ISimulation):
    """ Class to generate simulated paths based on
...
class SquareRootDiffusion(ISimulation):
    """Class to generate simulated paths based on
